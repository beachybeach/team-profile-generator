  ...
  const Employee = await inquirer
    ...
    .then((Employee) => {
      this.manager = new Manager(
        ...
        Employee.id,
        Employee.Email,
        Employee.member = "Manager".Employee.officeNumber),
     ...
     await inquirer.prompt([
  {
    ...
    .then(({ school }) => {
      this.Intern = new Intern(
        Employee.name, Employee.id, Employee.email, Employee.member, school);
      }) 
      ...
      .then(({ github }) => {
        this.Engineer = new Engineer(
          Employee.name, Employee.id, Employee.email, Employee.member, github
        );
      })
